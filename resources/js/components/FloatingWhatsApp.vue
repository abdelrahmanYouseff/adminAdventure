...
const raw =
    ...
    '966500000000';
const digits = raw.replace(/\D/g, '') || '966500000000';

const href = `https://wa.me/${digits}?text=${encodeURIComponent('مرحباً، أريد الاستفسار عن تأجير الألعاب')}`;
</script>
...
<template>
    <a
        ...
        class="floating-wa fixed z-[100] flex h-14 w-14 items-center justify-center rounded-full text-white shadow-xl transition hover:scale-110 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
