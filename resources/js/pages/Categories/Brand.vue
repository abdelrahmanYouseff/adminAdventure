...
import { ArrowRight, Edit, ImageIcon, Plus, Trash2 } from 'lucide-vue-next';
            ...
            >
                <div class="border-b border-neutral-200 px-5 py-5 dark:border-neutral-700 sm:px-6">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex min-w-0 items-start gap-3">
                            <Button variant="outline" size="icon" class="mt-0.5 shrink-0" as-child>
                            ...
                            <div class="min-w-0">
                                ...
                                <p class="mt-1 text-sm leading-relaxed text-neutral-500 dark:text-neutral-400">
                                    عرض وتعديل تصنيفات منتجات هذا البراند مع عدد المنتجات المرتبطة بكل صنف.
                                </p>
                            </div>
                        </div>
                        <Button as-child class="shrink-0">
                            <Link :href="route('categories.create', { brand: brand.id })">
                ...
                <div class="p-4 sm:p-6">
                    <Table class="text-sm">
                        ...
                        <TableBody>
                            <TableRow v-if="brand.categories.length === 0" class="hover:bg-transparent">
                                <TableCell colspan="5" class="h-32 text-center align-middle">
                                    <p class="text-neutral-500 dark:text-neutral-400">
                                        لا توجد أصناف لهذا البراند بعد. اضغط «إضافة صنف جديد» للبدء.
                                    </p>
                                </TableCell>
                            </TableRow>
                            <TableRow v-for="category in brand.categories" :key="category.id">
