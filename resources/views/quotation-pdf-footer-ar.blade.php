...
@endphp
<table width="100%" cellpadding="0" cellspacing="0" style="font-family: dejavusans, sans-serif; font-size: {{ $pt(6.5) }}; color: #1a1a1a; border-top: 1px solid #333; padding-top: {{ $pt(3) }}; direction: rtl;">
    <tr>
        <td width="28%" valign="middle" align="right" style="font-size: {{ $pt(6.5) }}; line-height: 1.4;">
            <span style="font-weight: bold;">رقم العرض:</span><br>
            <span style="font-weight: bold; direction: ltr; unicode-bidi: embed;">{{ $data->quotationNumber() }}</span>
        </td>
        <td width="54%" valign="middle" align="center" style="font-weight: bold; font-size: {{ $pt(7) }}; line-height: 1.3;">
            {{ $data->companyLegalNameAr() }}
            <div style="font-size: {{ $pt(6.5) }}; font-weight: normal; direction: ltr;">
