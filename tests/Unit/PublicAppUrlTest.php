...
{
    public function test_keeps_www_from_public_url(): void
    {
        config(['app.public_url' => 'https://www.admin.adventureksa.com']);

        $this->assertSame(
            'https://www.admin.adventureksa.com/order/shz71/location',
            PublicAppUrl::to('/order/shz71/location')
        );
    }

    public function test_uses_public_url_without_forcing_www(): void
    {
